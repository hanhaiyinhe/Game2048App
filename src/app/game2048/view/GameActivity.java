...
import app.game2048.business.GameView;
...
public class GameActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//GameView 初始化
		mGameView=new GameView(this,level_id,Record,level,mode);
	...
	public void onClick(View v) {
		...
		case R.id.btn_restart:
			mGameView.startGame(this.level_id,Record);
			setScore(0);
			break;
		...
		case R.id.btn_exit:
			...
			.setPositiveButton("保存", new DialogInterface.OnClickListener() {			
				...
				public void onClick(DialogInterface dialog, int which) {
					// TODO Auto-generated method stub
					Editor editor=Config.preferences.edit();
					editor.putInt("save_id", GameActivity.this.level_id);
					editor.putInt("score", Integer.parseInt(GameActivity.this.tvScore.getText().toString()));
					editor.putString("cardnums", mGameView.getCardnums());
					editor.commit();
